...
const audioFiles = [
  { name: "samuel", url: "https://hc-cdn.hel1.your-objectstorage.com/s/v3/cce5f0a33fe859e83cbf2fa0dbd976b0ba096d1a_samuel_f_audio.mp4" },
  { name: "deven", url: "" },
  { name: "ian", url: "" },
  { name: "zach", url: "" },
  { name: "max", url: "" },
...
export default function App() {
  const uploadAudio = (blob: any) => {
    ...
    xhr.open("POST", "https://b840-129-159-32-185.ngrok-free.app", true);
  ...
  const characters = [
    ...
    { id: "2", name: "Deven", avatar: "/placeholder.svg?height=80&width=80", mp3: "" },
    { id: "3", name: "Ian", avatar: "/placeholder.svg?height=80&width=80", mp3: "" },
    { id: "4", name: "Zach", avatar: "/placeholder.svg?height=80&width=80", mp3: "" },
    { id: "5", name: "Max", avatar: "/placeholder.svg?height=80&width=80", mp3: "" },
    { id: "6", name: "Ruby", avatar: "/placeholder.svg?height=80&width=80", mp3: "" },
  ];
